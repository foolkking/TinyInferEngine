 ...
 * @LastEditors: fool
 * @LastEditTime: 2026-04-29 10:52:28
...
private:
    ...
    TensorPtr weight_; // 形状: [out_channels, in_channels, kernel_size, kernel_size]  
    TensorPtr bias_;   // 形状: [out_channels]
protected:
...
public:
    ...
    std::vector<NamedParameter> parameters()override; // 返回权重和偏置作为命名参数
